...
export class LPController {
    ...
    updateListViewDataSource() {
        const controlName = location.hash.split('/')[2] || samplesList[0].path;
        this.listComponent.dataSource = <any>(this.controlSampleData[controlName] || this.controlSampleData['grid']);
